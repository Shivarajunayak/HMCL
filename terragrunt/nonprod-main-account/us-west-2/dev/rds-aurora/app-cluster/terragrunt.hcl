...
inputs = {
  name                        = "hmcl-cv-${local.environment}-app-cluster"
  ...
  database_name               = "thor_application_db"
  instances = {
    1 = {
      identifier          = "app-instance-1"
  ...
  db_subnet_group_name   = "hmcl-cv-${local.environment}-app-db-subnet-group"
  ...
  db_cluster_parameter_group_name        = "hmcl-cv-${local.environment}-app-cluster-parameter-group"
  db_cluster_parameter_group_family      = "aurora-postgresql16"
  db_cluster_parameter_group_description = "app cluster parameter group"
  ...
  db_parameter_group_name        = "hmcl-cv-${local.environment}-app-parameter-group"
  db_parameter_group_family      = "aurora-postgresql16"
  db_parameter_group_description = "app DB parameter group"
