...
terraform {
  source = "git@ssh.dev.azure.com:v3/hero-ev-team/CVPI%20-%20Thor%20Infra%20DevOps/thor-infra-terraform-modules//modules/acmpca?ref=feature_acmpca"
}
...
inputs = {
  root_ca_common_name              = "hmcl-cv-${local.environment}-konnect.heromotocorp.com"
  subordinate_ca_common_name       = "hmcl-cv-${local.environment}-konnect.heromotocorp.com"
  ...
  root_ca_validity_years           = 50
  subordinate_ca_validity_years    = 15

  tags = {
    Owner               = "dev-team"
    project-name        = "connected-vehicle-platform"
    Name                = "hmcl-cv-${local.environment}-acmpca"
