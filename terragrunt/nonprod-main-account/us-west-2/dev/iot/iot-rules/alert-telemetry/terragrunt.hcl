...
inputs = {
  iot_topic_rules = {
    thor_alert_telemetry = {
      rule_name   = "hmcl_cv_${local.environment}_thor_alert_telemetry"
      sql         = "SELECT * FROM 'dt/hmcl/campaign_data'"
      sql_version = "2016-03-23"
      description = "hmcl_cvp_demo_thor_alert_telemetry"
      needs_iam   = true
      ...
      tags = {
        ...
        Name                = "hmcl-cv-${local.environment}-alert-telemetry-rule"
