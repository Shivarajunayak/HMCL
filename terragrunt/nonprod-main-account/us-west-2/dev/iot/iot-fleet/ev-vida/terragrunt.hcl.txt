...
terraform {
  source = "git@ssh.dev.azure.com:v3/hero-ev-team/CVPI%20-%20Thor%20Infra%20DevOps/thor-infra-terraform-modules//modules/iot/iot-fleet?ref=feature_iot"
}
...
inputs = {
  ...
  fleet_id               = "EV-VIDA1"
  fleet_description      = "EV VIDA Fleet"
