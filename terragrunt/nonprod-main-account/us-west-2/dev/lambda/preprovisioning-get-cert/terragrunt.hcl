...
inputs = {
  ...
  function_name          = "hmcl-cv-${local.environment}-preprovisioning-get-cert-lambda"
  description            = "preprovisioning get cert API Lambda"
  ...
  s3_existing_package = {
    ...
    key    = "preprovisioning-get-cert-api/hmcl-cvp-preprovisioning-get-cert-api.zip"
  }
  ...
  role_name                         = "hmcl-cv-${local.environment}-${local.aws_region_short}-preprovisioning-get-cert-role"
