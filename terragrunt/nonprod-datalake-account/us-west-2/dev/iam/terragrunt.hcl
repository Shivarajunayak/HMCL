...
terraform {
  source = "git@ssh.dev.azure.com:v3/hero-ev-team/CVPI%20-%20Thor%20Infra%20DevOps/thor-infra-terraform-modules//modules/iam"
}
...
locals {
  ...
  iam = yamldecode(file("${get_terragrunt_dir()}/configs/iam.yaml"))
